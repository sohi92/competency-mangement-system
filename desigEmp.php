...
//  importing confiq file.
 include("config.php");
 $query = "SELECT Designation, COUNT(*) AS number FROM employee GROUP BY Designation";  
 // running query.
 ...
 <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  // to draw chart.
                var Tbdata = google.visualization.arrayToDataTable([  
                          ['Designation', 'Number'],  // data to table
                          <?php  
                ...
                var opt = {  
                      title: 'Employees With Different Designation',  
                      //3D effect.
     slices: {  2: {offset: 0.2},
                
     },
					  colors: ['#180f3d', '#3d0f0f','#2c5941'],
                      pieHole: 0.2  
                     };  
    ...
    <div id="content">
      ...
      <div style="text-align: center; align: center;">
        <!-- insert the page content here -->
           <div >  
                <h2 align="center">Showing Percentage of Employees belongs to a Particular Designation</h2>  
                <br />  
